defmodule Bitcoin.Protocol.Types.TxInput do
  ...
  defimpl Inspect, for: __MODULE__ do
    @spec inspect(
            atom() | %{previous_output: any(), sequence: any(), signature_script: binary()},
            any()
          ) :: <<_::64, _::_*8>>
    def inspect(data, _opts) do
      "%In{ ##{data.sequence} output: #{data.previous_output |> Kernel.inspect()}, sig: #{
        data.signature_script |> Base.encode16()
      } }"
    end
  end
